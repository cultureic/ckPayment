...
import { createicrc1Actor } from "../../../src/SDK/ic/icpswap/icrc1/index.js";
...
export default function TokenIcon({ 
  ...
  const fetchTokenLogo = async (canisterId) => {
    ...
    try {
      ...
      const knownLogos = getKnownTokenLogo(canisterId);
      if (knownLogos) {
        setLogoUrl(knownLogos);
        setLoading(false);
        return;
      }

      // Try to fetch from ICRC1 metadata
  ...
  const getKnownTokenLogo = (canisterId) => {
    // Known token logos mapping
    const tokenLogos = {
      'ryjl3-tyaaa-aaaaa-aaaba-cai': 'https://cryptofonts.com/img/ICP.svg', // ICP
      'mxzaz-hqaaa-aaaar-qaada-cai': 'https://cryptofonts.com/img/icons/btc.svg', // ckBTC
      'ss2fx-dyaaa-aaaar-qacoq-cai': 'https://cryptofonts.com/img/icons/eth.svg', // ckETH
      'xkbw2-lqaaa-aaaah-qcr7a-cai': 'https://cryptofonts.com/img/icons/usdt.svg', // ckUSDT
      'rdmx6-jaaaa-aaaah-qcgkq-cai': 'https://cryptofonts.com/img/icons/usd.svg', // ckUSDC
    };
    return tokenLogos[canisterId?.toString()] || null;
  };
